...
export class Directions {
  ...
  static calculateHaversineDistance(a: ILatLngPosition, b: ILatLngPosition): number {
  ...
  static calculateCompassDirection(a: ILatLngPosition, b: ILatLngPosition): number {
  ...
  constructor(
    public start: ILatLngPosition,
    public end: ILatLngPosition
  ) {
